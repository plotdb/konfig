...
(function(){
  var rescope, sanitize, rid, parseNameString, pubsub, block, slice$ = [].slice;
  ...
  block['class'].prototype = import$(Object.create(Object.prototype), {
    _init: function(){
      ...
      return block.init().then(function(){
        ...
        this$.id = (this$['interface'].pkg.name || rid()) + "@" + (this$['interface'].pkg.version || rid());
